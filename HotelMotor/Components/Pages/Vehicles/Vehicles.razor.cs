...
namespace HotelMotor.Components.Pages.Vehicles
{
    public partial class Vehicles
    {
        ...
        private string GetVehicleImage(VehicleType vehicleType)
        {
            ...
            {
                VehicleType.Motorcycle => "images/vehicles/motos.jpg", // Reemplaza con la ruta de tu imagen de moto
                VehicleType.Car => "images/vehicles/carros.jpg", // Reemplaza con la ruta de tu imagen de carro
                _ => "images/vehicles/motoycarro.jpg" // Imagen predeterminada para otros tipos
            };
        }
    }
}
